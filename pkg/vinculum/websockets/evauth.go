...
type EventAuthFunc func(ctx context.Context, msg *WireMessage) (*WireMessage, error)

// Predefined event authorization policies

// AllowAllEvents is an EventAuthFunc that allows all events without modification.
func AllowAllEvents(ctx context.Context, msg *WireMessage) (*WireMessage, error) {
...
func DenyAllEvents(ctx context.Context, msg *WireMessage) (*WireMessage, error) {
...
func DropAllEvents(ctx context.Context, msg *WireMessage) (*WireMessage, error) {
...
func AllowTopicPrefix(prefix string) EventAuthFunc {
	return func(ctx context.Context, msg *WireMessage) (*WireMessage, error) {
...
//	    func(ctx context.Context, msg *WireMessage) (*WireMessage, error) {
